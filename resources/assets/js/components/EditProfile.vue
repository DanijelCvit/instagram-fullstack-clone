<template>
	<div>
		<form class="container card py-2 my-5 shadow" @submit.prevent="submitForm" enctype="multipart/form-data">
			<div class="form-group">
				<h2 class="text-center">Edit Profile</h2>
				<img id="profilepic" class="rounded-circle mx-auto d-block my-3" :src="user.image" alt="">
				<h5 class="text-center">@{{user.username}}</h5><br>
				...
				<button type="submit" class="btn btn-primary my-3 row w-25 mx-auto d-block">Save Changes</button>
			</div>
		</form>
	</div>
</template>
