<template>
  <div class="container mt-5">
    <div class="shadow row justify-content-center bg-white rounded py-3">
      <div
        class="col-12 col-md-6 col-lg-6 justify-content-center d-flex align-items-center flex-wrap mb-3"
      >
        <img
          :src="imageUrl"
          alt=""
      ...
      <div class="col-8 col-md-6 col-lg-6 text-center">
        ...
        <p>{{ user.email }}</p>
        <button @click="swapComponent('editProfile')" class="btn btn-light">
          Edit Profile
        </button>
      </div>
    </div>
